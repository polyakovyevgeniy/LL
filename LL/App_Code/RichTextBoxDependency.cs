...
{
    /// <summary>
    /// Определяет свойство зависимости для RichTextBox
    /// </summary>
    class RichTextBoxDependency
    {
        public static readonly DependencyProperty BoundDocument =
 DependencyProperty.RegisterAttached("BoundDocument", typeof(string), typeof(RichTextBoxDependency),
